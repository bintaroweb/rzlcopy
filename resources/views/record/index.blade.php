...
<div class="row">
    <div class="col-md-8">
        <!-- Page Heading -->
        <h1 class="h3 mb-3 text-gray-800" id="title">Machine Record <strong>{{ $customer->customer_name }}</strong></h1>
    </div>
    <div class="col-md-4 d-md-flex justify-content-md-end">
        ...
        <a href="{{ url('/records/create/?id=') }}{{$customer->uuid}}" class="btn btn-primary btn-md mb-3"><i class="fas fa-plus"></i> Tambah</a>
    </div>
</div>
            ...
            <table class="table" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th>Mesin</th>
                        <th>Problem</th>
                        <th>Replace / Adjustment/Comment/Attantion</th>
                        <th>Counter</th>
                        <th>Teknisi</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable( {
            ...
            serverSide: true,
            ordering: false,
            ajax: "{{ url('records/datatable/?id=') }}" + getUrlParameter('id'),
