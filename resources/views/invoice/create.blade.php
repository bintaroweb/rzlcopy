        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Invoice</h4>
                </div>
                <form method="post" action="{{ url('/deliveries') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="title" class="required">Jenis Invoice</label>
                                    <select name="type" class="form-control @error('type') is-invalid @enderror type" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group sewa">
                                    <label for="delivery_date" class="required">Tanggal Pengiriman</label>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="table-row">
                                    ...
                                    <td><input type="number" class="form-control" name ="qty[1]" required></td>
                                    <td><input type="number" class="form-control" name ="total[1]" required></td>
                                    <!-- <td>
