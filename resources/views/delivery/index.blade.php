...
<div class="row">
    <div class="col-md-8">
        <!-- Page Heading -->
        <h1 class="h3 mb-3 text-gray-800" id="title">Surat Jalan <strong>{{ $customer->customer_name }}</strong></h1>
    </div>
    <div class="col-md-4 d-md-flex justify-content-md-end">
        <a href="{{ url('/deliveries/create/?id=') }}{{$customer->id}}" class="btn btn-primary btn-md mb-3"><i class="fas fa-plus"></i> Tambah</a>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable( {
            ...
            serverSide: true,
            ordering: false,
            ajax: "{{ url('deliveries/datatable/?id=') }}" + getUrlParameter('id'),
            columns: [
